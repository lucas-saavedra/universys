...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2021 a las 16:40:53
...
CREATE TABLE `asistencias` (
  ...
  `det_jornada_id` int(11) NOT NULL
...
INSERT INTO `asistencias` (`id`, `fecha`, `hora_inicio`, `hora_fin`, `dia_id`, `estado_asistencia`, `descripcion`, `docente_id`, `det_jornada_id`) VALUES
(24, '2021-04-30 00:00:00', '09:08:00', '10:08:00', 4, 'tarde', '', 2, 8),
(25, '2021-04-30 00:00:00', '09:00:00', '11:05:00', 4, 'presente', '', 3, 5);

--
-- Disparadores `asistencias`
--
DELIMITER $$
CREATE TRIGGER `asistencias_trigger` BEFORE INSERT ON `asistencias` FOR EACH ROW BEGIN
...
(6, '06:00:00', '10:00:00', 4, 3, 1),
(7, '11:00:00', '13:00:00', 4, 3, 3),
(8, '09:00:00', '10:00:00', 4, 1, 4);
...
(1, 'mañana', '2021-04-20', '2021-05-20'),
...
(100, '2021-04-30', '09:00:00', 4, 3, 5, 'entrada'),
(101, '2021-04-30', '09:08:00', 4, 2, 8, 'entrada'),
(102, '2021-04-30', '10:08:00', 4, 2, 8, 'salida'),
(103, '2021-04-30', '11:05:00', 4, 3, 5, 'salida'),
(104, '2021-04-30', '06:05:00', 4, 3, 6, 'entrada'),
(105, '2021-04-30', '10:05:00', 4, 3, 6, 'salida');
