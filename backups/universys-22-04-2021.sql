...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2021 a las 16:45:56
...
(5, '09:00:00', '11:00:00', 3, 3, 2),
(6, '06:00:00', '09:00:00', 3, 3, 1),
(7, '11:00:00', '13:00:00', 3, 3, 3);
...
INSERT INTO `marcacion` (`id`, `fecha`, `hora_registro`, `dia_id`, `docente_id`, `detalle_jornada_id`) VALUES
(47, '2021-04-22', '11:11:28', 3, 3, 5),
(48, '2021-04-22', '11:11:31', 3, 3, 5);
...
ALTER TABLE `marcacion`
  ...
  ADD CONSTRAINT `marcacion_ibfk_2` FOREIGN KEY (`detalle_jornada_id`) REFERENCES `detalle_jornada` (`id`);
COMMIT;
