...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2021 a las 16:43:20
...
(7, '2021-04-23 00:00:00', '09:10:00', '11:10:19', 4, 'tarde', '', 3, 5),
(8, '2021-04-23 00:00:00', '09:11:33', '10:40:45', 4, 'tarde', '', 2, 5);
...
CREATE TRIGGER `asistencias_trigger` BEFORE INSERT ON `asistencias` FOR EACH ROW BEGIN
    ...
    select TIMEDIFF(new.hora_inicio, @hora_jornada) > '00:05:00' into @diferencia;
...
(5, '09:00:00', '11:00:00', 0, 3, 2),
(6, '06:00:00', '10:00:00', 0, 3, 1),
(7, '11:00:00', '13:00:00', 0, 3, 3);
...
(65, '2021-04-23', '09:10:00', 4, 3, 5, 'entrada'),
(66, '2021-04-23', '11:10:19', 4, 3, 5, 'salida'),
(67, '2021-04-23', '09:11:33', 4, 2, 5, 'entrada'),
(68, '2021-04-23', '10:40:45', 4, 2, 5, 'salida');
