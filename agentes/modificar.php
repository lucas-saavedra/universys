...
function _get_agente_roles($bd, $id){
    ...
    return array_map(function($n){return $n['rol_id'];}, $result);
}
                            ...
                            <tbody>
                                <?php if (isset($agente['id_docente'])): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger" type="submit" name="del-doc" value="1"
                                                onclick="return confirm('¿Eliminar tipo docente?')">
                                ...
                                <?php if (isset($agente['id_no_docente'])): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger" type="submit" name="del-no-doc" value="1"
                                                onclick="return confirm('¿Eliminar tipo no docente?')">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
