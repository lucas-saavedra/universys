        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit">traer expedientes</button>
                </div>
            </form>  
        </div>
    </div>
    <?php 
      $query_fecha = "SELECT DISTINCT fecha from inasistencia_sin_aviso_docente";
      ...
      while($row_fecha = mysqli_fetch_array($result_fecha)) {
        $fecha= $row_fecha['fecha'];
          ...
          (SELECT DISTINCT docente_id, fecha from inasistencia_sin_aviso_docente where fecha = '$fecha' ) 
...
<table class="table table-striped table-dark">
  ...
  <tbody>
    ...
    <tr>
      ...
      <?php 
        $contador="SELECT COUNT(docente_id) from inasistencia_sin_aviso_docente where fecha= '$fecha'";
      ...
      <?php echo $row_contador[0]?>
        ...
        <?php 
            $query_total = "SELECT * FROM inasistencia_sin_aviso_docente WHERE fecha = '$fecha'";
      ...
      <table class="table table-striped ml-5">
        ...
        <tbody>
          <?php 
            ...
            $query_inasist = "SELECT * FROM inasistencia_sin_aviso_docente WHERE fecha='$fecha'";
