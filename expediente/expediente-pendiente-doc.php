    ...
    ?>
                    <tbody>
                        <tr>
                            ...
                            <td><?php if( $row_expdt_docente_id['aviso_id'] == NULL){ echo 'Sin aviso';} else{echo 'aviso valido';}?></td>
                            <td style="color:blue"><?php if( $row_expdt_docente_id['doc_justificada_id'] == NULL){ echo 'Sin Documentación';}?></td>
                ...
                ?>
                        <tbody>
                            <tr>
                                ...
                                <td><?php if( $row_expdt_no_docente_id['aviso_id'] == NULL){ echo 'Sin aviso';}else{echo 'aviso valido';}?></td>
                                <td style="color:blue"><?php if( $row_expdt_no_docente_id['doc_justificada_id'] == NULL){ echo 'Sin Documentación';}?></td>
                                <td> <button>Agregar Doc</button></td>
                            </tr>
                <?php
                            }  
