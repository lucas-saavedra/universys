    ...
    <div class="form-group col-md-6">
        <div class="input-group">
            <div class="input-group-prepend">
                <span data-toggle="collapse" role="button" type="submit" href="#agente_tabla" class="btn btn-outline-success" id="inputGroupPrepend"><i class="fas fa-search"></i></span>
            </div>
            <input autocomplete="off" class="form-control" autofocus type="search" id="search-agente" placeholder="Ingrese el nombre del agente" aria-label="Search">
        </div>
    </div>
